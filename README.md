...
| Test and CI strategy | [docs/testing/test-strategy.md](docs/testing/test-strategy.md) | Strategy accepted and machine-checked; eight of eleven test layers exist, three do not, and no CI lane is configured |
