...
| Losing the serving pod under load | local real, `C2` | The replacement reported Ready 33 665 ms after the delete; callers saw a 31 960 ms outage in which 40 of the 41 requests dispatched were refused; nobody intervened | [Pod recovery](docs/proof/serving/v1-s4-006-pr1-inference-pod-recovery.md) |
...
| Pod loss | local real | Replacement Ready 33 665 ms after the delete; 31 960 ms caller-visible outage; 40 of the 41 requests dispatched in it refused; the deleted pod reported Ready throughout while the Service had no ready endpoint | An availability figure, an error budget, an SLO, or a recovery-time objective | [V1-S4-006-PR1](docs/proof/serving/v1-s4-006-pr1-inference-pod-recovery.md) |
