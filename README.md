...
| Pod loss | local real | Replacement Ready 33 665 ms after the delete; 31 960 ms caller-visible outage; 40 of the 41 requests dispatched in it refused; until the replacement was observed Ready, the deleted pod reported Ready while the Service had no ready endpoint | An availability figure, an error budget, an SLO, or a recovery-time objective | [V1-S4-006-PR1](docs/proof/serving/v1-s4-006-pr1-inference-pod-recovery.md) |
