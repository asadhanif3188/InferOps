...
| Architecture and ADRs | [docs/architecture/README.md](docs/architecture/README.md) | Six decisions accepted in part, one accepted with a recorded exception, one accepted |
