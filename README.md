...
| Architecture and ADRs | [docs/architecture/README.md](docs/architecture/README.md) | Three decisions accepted in part, one accepted with a recorded exception, one accepted |
...
| Test and CI strategy | [docs/testing/test-strategy.md](docs/testing/test-strategy.md) | Strategy accepted and machine-checked; five of eleven test layers exist and no CI lane is configured |
...
| Claim and test matrix | [docs/testing/claim-test-matrix.md](docs/testing/claim-test-matrix.md) | Nine of eighteen public claims certified; the rest are commitments |
