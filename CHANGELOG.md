...
- **A versioned claim and evidence data model that can hold what the evidence-level
  ...
  **Nothing is migrated and nothing is reclassified.**
  ...
  restate fifty-nine classifications in a vocabulary they were not made in. The
  claim-by-claim reading is `V1-S5-012-PR2`, and validators for the rules a schema
  cannot check are `V1-S5-012-PR1`.
  ...
  **One consumer changed.** [The proof dashboard](docs/proof/dashboard.md) gained a
  ...
  instead of being refused. The committed page is unchanged.
