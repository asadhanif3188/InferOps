...
empty list. There are thirty-nine, and they are listed in their own section rather than
hidden in the data.
...
Thirty-seven modules. Committed machine-readable data checked against the documents
...
that specification describes, and `V1-S5-012-PR1` the thirty-seventh, which drives
