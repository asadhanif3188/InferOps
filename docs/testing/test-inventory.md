...
source and cache workflow, runtime profile, standalone package, and registered
serving baseline — and, since the API began emitting, the catalog checked against
what the distribution declares rather than only against its own prose.
