...
| Test, CI, and certification strategy | Test layers, lanes, markers, certification levels, and evidence retention | [ADR 0005](../architecture/decisions/ADR-0005-test-ci-and-certification-strategy.md) accepted in part; the strategy is machine-checked and five of its eleven test layers have no code |
