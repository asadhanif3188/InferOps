...
| Telemetry collection and ingress ownership | Collector selected; the rest not | [ADR 0004](../architecture/decisions/ADR-0004-component-and-ownership-boundaries.md) D7, amended 2026-09-09: the collector is Helm-owned and release-scoped and a release has installed one. An ingress or load-balancer implementation, a durable store, dashboards and alert routing stay unowned and deferred out of V1 |
