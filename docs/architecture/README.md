...
| [0007](decisions/ADR-0007-inference-cost-method.md) | Inference cost-calculation method | Accepted in part; amended 2026-09-15 | 2026-08-26; amended 2026-09-15 | [Change validation](../proof/cost/v1-s0-008-pr1-validation.md); the method and its worked example are machine-checked. D1, D2, and D9 are amended by 0014, and no platform component computes a cost record |
...
| [0014](decisions/ADR-0014-v1-cost-calculation-reaches-the-estimated-basis.md) | The V1 cost calculation reaches the estimated basis, from bounded measured use | Accepted in part | 2026-09-15 | [Change validation](../proof/cost/v1-s4-005-pr1-validation.md); amends ADR 0007 D1, D2, and D9. The basis, the price-source refusals, the arithmetic, and the record shape are machine-checked on synthetic fixtures; D3's rules for taking usage from samples are review only, because every usage value is typed in by hand. No cost figure is published |
