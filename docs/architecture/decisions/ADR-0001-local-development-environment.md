...
| R7 | No public maintainer roster exists | **Resolved 2026-09-21** by [ADR 0015](ADR-0015-v1-decision-ownership-and-sign-off-authority.md) | The risk was stated as the absence of a roster; the blocker was the absence of a decision. This record's decision owner is now the `repository-maintainer` role, assigned retrospectively. Its partial acceptance still rests on evidence rather than on an approval, and the assignment did not re-review that evidence. |
