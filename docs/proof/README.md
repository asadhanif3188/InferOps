...
[the normalization ledger](testing/v1-s5-006-pr1-normalization.v1alpha1.json), and
[the completeness ledger](testing/v1-s5-006-pr2-completeness.v1alpha1.json), and a
...
**The evidence here is not frozen.** [The completeness check](testing/v1-s5-006-pr2-evidence-completeness.md)
found five certified claims whose only supporting record ran repository code nothing
identifies, and holds each as a release blocker with the run that would close it;
`python -m tools.evidence_index --gate` exits 1 until they are closed.
